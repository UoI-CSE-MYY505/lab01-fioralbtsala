...
matric: # Words ending with ':' are **labels**
        ...
        .word 5165  # This directive reserves enough space for a word in memory
...
prog:   # Labels in code are used for control flow: if/then/else, loops, etc.
        ...
        lw         s0, 0(a0)       # s1 gets the value of var1. a1 has the address of var1
        add        s1, s1,   s0    # s1 = var1 + s0
        sw         s1, 4(a0)       # matricplus1 = var1 + s0
        
        sw         s0, 4(a2)     # Store s0 to the 4th element of array
